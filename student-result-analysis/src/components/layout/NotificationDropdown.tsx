...
const ADMIN_NOTIFICATIONS: Notification[] = [
  ...
  },
  {
    ...
    message: "Student result Excel file was uploaded successfully.",
    time: "1 hour ago",
    type: "success",
  },
  {
  ...
  {
    id: "a4",
    title: "Result Analysis Updated",
    message: "Student result analysis has been updated.",
    time: "1 day ago",
    type: "update",
  },
  {
    id: "a5",
    title: "System Update",
    message: "Student Result Analysis system is running normally.",
    time: "2 days ago",
    type: "info",
  },
];
...
const STUDENT_NOTIFICATIONS: Notification[] = [
  {
    ...
    message: "Your latest semester results have been published.",
    time: "2 minutes ago",
    type: "success",
  },
  {
    ...
    message: "Your result information has been updated.",
    time: "1 hour ago",
    type: "update",
  },
  {
    ...
    message: "Your latest performance analysis is now available.",
    time: "5 hours ago",
    type: "info",
  },
  {
    id: "s4",
    title: "SGPA Updated",
    message: "Your semester SGPA information has been updated.",
    time: "1 day ago",
    type: "update",
  },
  {
    ...
    message: "A new academic announcement is available.",
    time: "2 days ago",
    type: "alert",
  },
];
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-1">
                      <p
                        className={`text-sm ${isRead ? "font-medium text-foreground" : "font-semibold text-foreground"}`}
                      >
                        {notif.title}
                      </p>
